...
public class UltimateTrevorBot extends Player {
    ...
    public boolean wantsToRoll(int myScore, int handScore, ArrayList<Integer> otherScores, int winningScore) {
        ...
        double leadingCompareOffset = map(leadingCompare, winningScore*-1, winningScore, 0.4, -0.4);    //convert from a scale of (-100, 100) to (0.5, -0.4)
        ...
        double myWinningDistanceOffset = map(myWinningDistance, 100, 1, 0.3, -0.3);    //convert from a scale of (100, 1) to (0.4, -0.3)
